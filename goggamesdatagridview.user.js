...
angular.module('gog').controller('DataGridController', ['\$scope', '\$http', '\$window', 'cart', 'wishlist', DataGridController]);
angular.module('gog').requires.push('ui.grid');
angular.module('gog').requires.push('ui.grid.autoResize');
...
.datagrid-title-mod { display:inline-block;position:relative;padding:0.2em 0.4em;font-size:0.6em;top:0.5em;line-height:1;margin-left:0.6em;border-radius:3px;height:1em;}
