...
<defs>
<symbol viewBox="0 0 13 12" id="gog-windows">
...
<symbol viewBox="0 0 13 12" id="gog-mac">
...
<symbol viewBox="0 0 13 12" id="gog-linux">
...
<symbol viewBox="0 0 16 13" id="gog-button-add-to-cart">
    <g id="button-add-to-cart_Symbols" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <g id="button-add-to-cart_Game-/-overlay" transform="translate(-249.000000, -201.000000)" fill="#FFFFFF">
...
<symbol viewBox="0 0 16 14" id="gog-button-in-cart">
    <g id="button-in-cart_Symbols" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <g id="button-in-cart_Game-/-overlay" transform="translate(-249.000000, -200.000000)" fill="#FFFFFF">
...
if(!isNew)
{
	...
	var installGrid = function()
	{
		...
		\$catalog.append(gogsymbols+gridhtml);
...
role="img" ng-show="!row.entity.inCart"><use xlink:href="#gog-button-add-to-cart"></use></svg><svg 
role="img" ng-show="row.entity.inCart"><use xlink:href="#gog-button-in-cart"></use></svg>
</button></div></div>\`
			},
...
DataGridController.prototype.osFilterHeader = function(msscope)
{
	...
	{
		hdr = \`<svg 
role="img"><use xlink:href="#gog-\${sel.toLowerCase()}"></use></svg>\`;
	}
	angular.element(msscope.element[0].querySelector('.ui-ms-pull-left')).html(hdr);
};
